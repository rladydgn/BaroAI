...
def get_memory_info() -> str:
    ...
    memory_info.extend(
        [int(memory.total / 1024 ** 3), int(memory.available / 1024 ** 3), round(memory.used / memory.total * 100, 3)])
...
def get_disk_info() -> str:
    ...
    for d in disk:
        ...
        disk_info.extend(
            [d[0], int(int(d[1]) / 1024 ** 2), int(int(d[2]) / 1024 ** 2), round(int(d[2]) / int(d[1]) * 100, 3)])
